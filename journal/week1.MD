...
## Considerations when using ChatGPT to write terraform. LLMs such as ChatGPT may not be traindedon the latest documetnation of information about terraform. 